...
import "./about.css";
import AboutImg from "../../assets/kimaro-home.jpg";
import CV from "../../assets/Tanzania_Patrick_Kimaro.pdf";
    ...
    <section className="about section" id="about">
        ...
        <div className="about_container container grid">
            ...
            <div className="about_data">
                ...
                <p className="about_description">I'm passionate software developer, Innovator, UI/UX designer and Self-motivated with experience in youth exploring the STEM Innovations space with a proven
ability to work with difficult tech work and provide a high service level to clients.
                </p>
                <a download="" href={CV} className="buttons button--flex">Download CV
                    <svg
                        class="button_icons"
